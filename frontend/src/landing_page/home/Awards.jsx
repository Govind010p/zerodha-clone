    ...
    <div className="container mt-2 px-md-4 px-4">
      <div className="row m-md-0 m-1 align-items-center  mobile-bordered">
        <div className="col-md-6 col-12 p-4 order-1 order-md-2">
          <h1 className="mb-3">
            Next-Generation Stock Trading & Investment Platform
          </h1>

          <p className="ms-2 para-fontsize-mobile">
            Tradvise empowers investors with real-time market insights, secure
            portfolio management, and a seamless trading simulation experience.
            Stay connected to live market movements, analyze trends, and make
            smarter investment decisions—all through an intuitive and responsive
            platform.
          </p>
